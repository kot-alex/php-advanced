...
class SqliteLikesRepository implements LikesRepositoryInterface
{
    ...
    public function save(Like $like): void
    {
        ...
        $this->logger->info("Like created: $likeUuid");
    }
    ...
    public function getByPostUuid(UUID $postUuid): array
    {
        ...
        if (!$result) {
            $this->logger->warning("Cannot find like(s) of post: $postUuid");
            throw new PostNotFoundException("Cannot find like(s) of post: $postUuid");
        }
    ...
    public function checkDuplicate(UUID $authorUuid, UUID $postUuid): void
    {
        ...
        if ($result) {
            $this->logger->warning("User $authorUuid already liked post $postUuid");
